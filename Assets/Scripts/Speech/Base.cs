...
public class Base
{
    ...
    public IEnumerator GetAccessToken()
    {
        ...
        {
            Debug.Log("成功获取数据" + www.downloadHandler.text);
        ...
        {
            Debug.LogError("语音合成 " + www.error);
            Debug.LogError("语音合成 Token was fetched failed. Please check your APIKey and SecretKey");
