...
namespace Leap.Unity {
  ...
  public class CapsuleHand : HandModelBase {
        ////用于计算的各个向量
        //public bool checkGesture = false;
        //private Vector3 palmVec3;       //掌心方向
        //private Vector3 indexFingerTipVec3;       //食指尖方向
        //private Vector3 thumbFingerTipVec3;       //大拇指尖方向
        //private Vector3 middleFingerTipVec3;       //中指尖方向
        //private Vector3 ringFingerTipVec3;       //无名指尖方向
        //private Vector3 littleFingerTipVec3;       //小指尖方向
    ...
    private Vector3[] _spherePositions;
        ...
        //检测手指是否弯曲
        private bool IsFingerBend(Vector3 palmVec3, Vector3 fingerTipVec3)
        {
            return Vector3.Dot(palmVec3.normalized, fingerTipVec3.normalized) < 0;
        }
        //
        private bool GetIsFacingCamera(Transform facingTransform, float minAllowedDotProduct = 0.8F)
        {
